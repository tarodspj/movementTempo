...
gulp.task('default', function () {
    runSequence(['less', 'html', 'image-min', 'copy-svg', 'copy-json'], 'concat-scripts', 'watch', callback);
});
...
//     runSequence(['less', 'html', 'image-min', 'copy-svg', 'copy-json'], 'concat-scripts', 'minify-js', 'watch', callback);
...
gulp.task('html', function() {
  gulp.src(Ruta.src + '*.html')
    ...
    // }))
    .pipe(injectSvg())
    .pipe(gulpif(conditionBuild, htmlmin({collapseWhitespace: true, conservativeCollapse: true, removeEmptyAttributes: false})))
